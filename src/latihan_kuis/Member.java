 ...
 * @author Cyborg_RT27
 */
public class Member extends Pembeli implements Interface{
    ...
    public Member(barang[] myBrg, String namaPembeli, String alamatPembeli, String kontakPembeli) {
...
*/
    ...
    public int totalHargaBeli(){
        ...
        for(barang brg : this.myBrg){
            totalHB += (0.85)*brg.getHarga()*(brg.getJumlah()/2);//(1-0.15)diskon
        }
        System.out.println("Sebelum Diskon member= "+totalHB);
        this.setTotalHargaBeli(totalHB); //harga sebelum diskon
        kelDis = totalHB/750000;
        //diskon setiap kelipatan 750 ribu dapat 10 persen
        total = totalHB - kelDis*(10*750000/100);
        return total;
